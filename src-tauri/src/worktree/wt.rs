...
mod tests {
    ...
    fn extracts_path_from_you_are_now_in_marker() {
        let stdout = "📦 Project: agent-cockpit\n\
                      🌿 Branch: 01HXYZ\n\
                      📂 Path: /Users/me/development/worktrees/agent-cockpit-01HXYZ\n\
                      ✅ Branch exists, creating worktree...\n\
                      📍 You are now in: /Users/me/development/worktrees/agent-cockpit-01HXYZ\n";
        let path = extract_worktree_path(stdout).expect("path should be extracted");
        assert_eq!(
            path,
            PathBuf::from("/Users/me/development/worktrees/agent-cockpit-01HXYZ")
        );
    }
