...
fn keybind_dto(keybind: Keybind) -> Option<KeybindDto> {
    let action = match keybind.action {
        ...
        KeybindAction::ScrollToTop => KeybindActionDto::ScrollToTop,
        KeybindAction::ScrollToBottom => KeybindActionDto::ScrollToBottom,
        KeybindAction::ScrollPageUp => KeybindActionDto::ScrollPageUp,
        KeybindAction::ScrollPageDown => KeybindActionDto::ScrollPageDown,
